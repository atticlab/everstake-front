          ...
          <CardAlt :isCoinImg="true">
            <div class="coin-logo">
              <div class="coin-logo__inner">
                <img src="~@/assets/img/coins-presentation/algorand.svg" alt="Algorand">
              </div>
            </div>
            <div class="coin-info__container">
              <div class="coin-info__intro">
                <h1 class="coin-info__title">Algorand</h1>
                <p class="coin-info__subtitle">{{ $t('coinPages.algorand') }}</p>
              </div>
            </div>
          </CardAlt>
        </div>
