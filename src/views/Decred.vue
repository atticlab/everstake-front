          ...
          <CardAlt :isCoinImg="true">
            <div class="coin-logo">
              <div class="coin-logo__inner">
                <img src="~@/assets/img/coins-presentation/decred.svg" alt="Decred">
              </div>
            </div>
            <div class="coin-info__container">
              <div class="coin-info__intro">
                <h1 class="coin-info__title">Decred</h1>
                <p class="coin-info__subtitle">{{ $t('coinPages.decred') }}</p>
              </div>
            </div>
          </CardAlt>
        </div>
